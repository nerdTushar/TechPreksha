...
export const submitProjectYoutubeReducer = (state={},action) => {
    switch(action.type){
        case 'TEAM_PROJECT_YOUTUBE_SUBMIT_REQUEST' :
            return{
                loading : true
            }
        case 'TEAM_PROJECT_YOUTUBE_SUBMIT_SUCCESS' :
            return{
                loading : false,
                success : true
            }
        case 'TEAM_PROJECT_YOUTUBE_SUBMIT_FAIL' :
            return{
                loading : false,
                error : action.payload
            }
