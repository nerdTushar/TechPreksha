...
export default function Contact() {
  return (
    ...
    <div className='shadow-2xl shadow-[#4f4e9e] h-[400px] rounded-2xl mt-[150px]'>
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className=' '>
        <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-3xl font-bold leading-tight text-[#4a4aa6] mt-4 sm:text-4xl lg:text-5xl">Contact us</h2>
            <p className="max-w-xl mx-auto mt-4 text-base leading-relaxed text-[#4a4aa6]">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
        </div>

        <div className="max-w-5xl mx-auto mt-12 sm:mt-16">
            <div className="grid grid-cols-1 gap-6 px-8 text-center md:px-0 md:grid-cols-3">
                <div className="overflow-hidden shadow-2xl shadow-[black] hover:bg-[#cccccc] bg-[#aeaeae] rounded-xl">
                    <div className="p-6">
                        <svg className="flex-shrink-0  w-10 h-10 mx-auto text-[black]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path
                                strokeLinecap="round"
...
{/* 
            <div className="mt-6 overflow-hidden bg-[#dbdada] rounded-xl">
